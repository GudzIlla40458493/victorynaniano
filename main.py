...
def set_question():
    num = fjvf.question_number
    question_lbl.setText(fjvf.questions[num]["Запитання"])
    answers[0].setText(fjvf.questions[num]["Правильна відповідь"])
    answers[1].setText(fjvf.questions[num]["Неправильна 1"])
    answers[2].setText(fjvf.questions[num]["Неправильна 2"])
    answers[3].setText(fjvf.questions[num]["Неправильна 3"])
